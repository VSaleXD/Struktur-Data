...
// Lihat hasil B-Tree
int main() {
    /* Jika Tree berikut ini sudah dikonstruksi Dengan Root 6 dan memiliki anak kiri (1, 2, 4)
       dan kanan (7,8,9)
           6
          / \
        1 2 4   7 8 9
    ...
    */
    ...
    struct node* root = NULL; // placeholder
    ...
    // Tambahkan Nilai 5
    cout << "Setelah menambakan ima 5: " << endl;
