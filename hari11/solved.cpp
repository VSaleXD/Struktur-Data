...
int main()
{
    ...
    while (1)
    {
        ...
        case 3:
        {
            int n, val;
            vector <int> nums;
            cout<<"Berapa banyak node yang akan ditambahkan? ";
            cin>>n;
...
void BST::fun_3(vector<int> nums)
{
    ...
    cout << "\nBerhasil menambahkan " << nums.size() << " node ke dalam Tree." << endl;
}
